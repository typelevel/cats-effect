...
object UnboundedQueueSink {
  implicit def catsContravariantForUnboundedQueueSink[F[_]]: Contravariant[UnboundedQueueSink[F, *]] =
    new Contravariant[UnboundedQueueSink[F, *]] {
      override def contramap[A, B](fa: UnboundedQueueSink[F, A])(f: B => A): UnboundedQueueSink[F, B] =
