 ...
 */
private[internals] final class DeferredCancelable {
  import DeferredCancelable._
...
private[internals] object DeferredCancelable {
  /**
   * Models the internal state of [[DeferredCancelable]]:
   *
