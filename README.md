...
```scala
libraryDependencies += "org.typelevel" %% "cats-effect" % "3.4.12"
```
...
libraryDependencies ++= Seq(
  "org.typelevel" %% "cats-effect-kernel" % "3.4.12",
  "org.typelevel" %% "cats-effect-laws"   % "3.4.12" % Test)
```
...
```scala
libraryDependencies ++= Seq(
  "org.typelevel" %% "cats-effect-std" % "3.4.12",
  "org.typelevel" %% "cats-effect"     % "3.4.12" % Test)
```
...
```scala
libraryDependencies += "org.typelevel" %% "cats-effect-testkit" % "3.4.12" % Test
```
