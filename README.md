...
```sbt
libraryDependencies += "org.typelevel" %% "cats-effect-laws" % "0.4" % "test"
```
...
Most of the API documentation can be found [in the scaladoc](https://oss.sonatype.org/service/local/repositories/releases/archive/org/typelevel/cats-effect_2.12/0.4/cats-effect_2.12-0.4-javadoc.jar/!/cats/effect/index.html).  To summarize though, the typeclass hierarchy looks something like this:
