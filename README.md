...
[![Discord](https://img.shields.io/discord/632277896739946517.svg?label=&logo=discord&logoColor=ffffff&color=404244&labelColor=6A7EC2)](https://discord.com/channels/632277896739946517/632278585700384799)
...
```scala
libraryDependencies += "org.typelevel" %% "cats-effect-testkit" % "3.1.0" % Test
```
