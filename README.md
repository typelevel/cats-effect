...
libraryDependencies ++= Seq(
  "org.typelevel" %% "cats-effect-kernel" % "3.6.4",
  "org.typelevel" %% "cats-effect-laws"   % "3.6.4" % Test)
```
...
```scala
libraryDependencies ++= Seq(
  "org.typelevel" %% "cats-effect-std" % "3.6.4",
  "org.typelevel" %% "cats-effect"     % "3.6.4" % Test)
```
...
```scala
libraryDependencies += "org.typelevel" %% "cats-effect-testkit" % "3.6.4" % Test
```
