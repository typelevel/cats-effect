...
class CachedStackTracingTests extends AsyncFunSuite with Matchers {
  ...
  test("cached stack tracing captures bind frames") {
  ...
  test("cached stack tracing captures async frames") {
