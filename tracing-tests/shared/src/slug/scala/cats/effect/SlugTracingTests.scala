...
class SlugTracingTests extends AsyncFunSuite with Matchers {
  ...
  test("slug tracing captures map frames") {
  ...
  test("slug tracing captures bind frames") {
  ...
  test("slug tracing captures async frames") {
  ...
  test("slug tracing captures pure frames") {
  ...
  test("slug tracing captures delay frames") {
  ...
  test("slug tracing captures suspend frames") {
