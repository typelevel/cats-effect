...
import cats.{~>, Applicative, Comonad, Defer, Eval, Foldable, Functor, Id, InjectK, Monad, StackSafeMonad, Traverse}
 ...
 * elimination.
 *
 * NB: This solely exists to fill the gap until typelevel/cats#3225 is merged and released
 */
...
object Free extends FreeInstances {
   ...
   */
  final private[ce3] case class Pure[S[_], A](a: A) extends Free[S, A]

  /** Suspend the computation with the given suspension. */
  final private[ce3] case class Suspend[S[_], A](a: S[A]) extends Free[S, A]

  /** Call a subroutine and continue with the given function. */
  final private[ce3] case class FlatMapped[S[_], B, C](c: Free[S, C], f: C => Free[S, B]) extends Free[S, B]
   ...
   */
  final private[ce3] class FreeInjectKPartiallyApplied[F[_], G[_]](private val dummy: Boolean = true) extends AnyVal {
   ...
   * Uses the [[http://typelevel.org/cats/guidelines.html#partially-applied-type-params Partially Applied Type Params technique]] for ergonomics.
   */
  final private[ce3] class FreeLiftInjectKPartiallyApplied[G[_]](private val dummy: Boolean = true) extends AnyVal {
...
sealed abstract private[ce3] class FreeInstances extends FreeInstances1 {
...
sealed abstract private[ce3] class FreeInstances1 {
